...
export const signout = <i className="fa-duotone fa-right-from-bracket"></i>
...
export const report = <i className="fa-solid fa-chart-column"></i>
export const status = <i className="fa-regular fa-circle-check"></i>